...
import cool from '../../images/post-fal-seeing-big-picture/20231130-tldraw-fal-0-so-cool.png';
...
<Image src={cool} alt="so cool. tldraw draw fast and fal." class="shadow-lg" />
...
Yes, the above hero image was geenrated using [fal](https://fal.ai) and the [fal-ai/flux/schnell](https://fal.ai/models/fal-ai/flux/schnell) model using the prompt:
