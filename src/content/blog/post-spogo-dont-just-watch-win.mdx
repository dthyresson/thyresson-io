...
<Image src={spogoIconLogTagline} alt="Spogo Icon, Logo and Tagline" class="shadow-lg" />
...
<Image src={spogoSolutions1} alt="Spogo one pager, page 1" class="shadow-lg" />
...
<Image src={spogoSolutions2} alt="Spogo one pager, page 2" class="shadow-lg" />
...
<Image src={spogoTrioScreens} alt="Spogo Trio Screens" class="shadow-lg" />
...
<Image src={sportTechie} alt="Spogo on SportTechie" class="shadow-lg" />
...
<Image src={wagersMap} alt="Spogo Sunday Wagers Map" class="shadow-lg" />
...
<video src={video} width="640" height="360" controls class="shadow-lg"></video>
<caption>
