...
<Image src={image1} alt="The Volkwagen Theory of Evolution" />
...
<Image src={image2} alt="The 1962 and a half Volkswagen" />
...
<Image src={image3} alt="Some shapes are hard to improve on" />

"Some shapes are hard to improve on." - From LOOK magazine, April, 9, 1963, page 73.

<Image src={image4} alt="Heard any volkswagen jokes lately?" />
...
<Image src={image8} alt="Think it over, New York, Chicago, San Francisco" />
...
<Image src={image9} alt="A Simple Story about a Simple Engine" />
...
<Image src={image11} alt="You're missing a lot when you own a Volkswagen" />
...
<Image src={image12} alt="After we paint the car we paint the paint" />
...
<Image src={image13} alt="Need a part?" />
...
<Image src={image16} alt="Don't let the low prices scare you off" />
...
<Image src={image19} alt="All for the price of a fancier priced car" />

"All for the price of a fancier priced car" -- July 1967. Can't tell from which magazine.

<Image src={image20} alt="Superwagon" />
...
<Image src={image21} alt="One hour later, it won't get hungry again" />
...
<Image src={image22} alt="Your very own love bug" />
