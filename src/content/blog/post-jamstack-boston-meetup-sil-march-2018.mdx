...
tags: ['Technology', 'JAMStack', 'Sports Innovation Lab', 'Sports']
---
...
<Image src={image2} alt="Jamstack Boston Meetup SIL March 2018" class="shadow-lg" />

We wanted understand how technology drives innovation in sports. And we were going to do this through data.

<Image src={image3} alt="Jamstack Boston Meetup SIL March 2018" class="shadow-lg" />

Our CEO was Angela Ruggiero, a gold medalist in Ice Hockey at the 1998 Olympics in Nagano.

<Image src={image5} alt="Jamstack Boston Meetup SIL March 2018" class="shadow-lg" />
...
<Image src={image6} alt="Jamstack Boston Meetup SIL March 2018" class="shadow-lg" />
...
<Image src={image7} alt="Jamstack Boston Meetup SIL March 2018" class="shadow-lg" />

I found JAMStack and Netlify thanks to some articles Matt Biilmann published and knew I had to learn more.

<Image src={image8} alt="Jamstack Boston Meetup SIL March 2018" class="shadow-lg" />
...
<Image src={jamstack_swag} alt="Jamstack Boston Meetup SIL March 2018" class="shadow-lg" />

They even sent us some swag for the event.

<Image src={image9} alt="Jamstack Boston Meetup SIL March 2018" class="shadow-lg" />

My JAMStack stack centered are where I'd store and access data. I chose Contentful for this.

<Image src={image10} alt="Jamstack Boston Meetup SIL March 2018" class="shadow-lg" />
...
<Image src={image11} alt="Jamstack Boston Meetup SIL March 2018" class="shadow-lg" />
...
<Image src={image12} alt="Jamstack Boston Meetup SIL March 2018" class="shadow-lg" />
...
<Image src={image13} alt="Jamstack Boston Meetup SIL March 2018" class="shadow-lg" />
...
<Image src={image14} alt="Jamstack Boston Meetup SIL March 2018" class="shadow-lg" />

The plan for SIL was to build a tech community hub for sports technology in Boston.

<Image src={image15} alt="Jamstack Boston Meetup SIL March 2018" class="shadow-lg" />

The plans for 2018 and beyond ...

<Image src={image16} alt="Jamstack Boston Meetup SIL March 2018" class="shadow-lg" />

Sadly, this was the only year of the meetup.

<Image src={image17} alt="Jamstack Boston Meetup SIL March 2018" class="shadow-lg" />
